...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.MainScreen.setGeometry(QtCore.QRect(80,0, w-80, h))
        self.MainScreen.setPixmap(QPixmap("./Images/bg.jpg").scaled(w, h, QtCore.Qt.AspectRatioMode.KeepAspectRatio))

        self.topbar = QtWidgets.QLabel(self.centralwidget)
        self.topbar.setGeometry(QtCore.QRect(w-400, 0, 400, 100))
        self.topbar.setPixmap(QPixmap("./Images/boxes.jpg"))
        ...
        self.Box1.setGeometry(QtCore.QRect((w/2)-450, (h/2)-250, 400, 200))
        self.Box1.setPixmap(QPixmap("./Images/boxes.jpg"))
        # self.SideBarLabel.setStyleSheet("image: url(:/newPrefix/Side Bar.jpg);")
        self.Box1.setText("")
        self.Box1.setObjectName("Box1")

        self.Box2 = QtWidgets.QLabel(self.centralwidget)
        self.Box2.setGeometry(QtCore.QRect((w / 2) + 50, (h / 2) - 250, 400, 200))
        self.Box2.setPixmap(QPixmap("./Images/boxes.jpg"))
        # self.SideBarLabel.setStyleSheet("image: url(:/newPrefix/Side Bar.jpg);")
        self.Box2.setText("")
        ...
        self.Box3.setGeometry(QtCore.QRect((w/2)-450, (h/2)+50, 400, 200))
        self.Box3.setPixmap(QPixmap("./Images/boxes.jpg"))
        # self.SideBarLabel.setStyleSheet("image: url(:/newPrefix/Side Bar.jpg);")
        self.Box3.setText("")
        self.Box3.setObjectName("Box3")

        self.Box4 = QtWidgets.QLabel(self.centralwidget)
        self.Box4.setGeometry(QtCore.QRect((w / 2) + 50, (h / 2) + 50, 400, 200))
        self.Box4.setPixmap(QPixmap("./Images/boxes.jpg"))
        # self.SideBarLabel.setStyleSheet("image: url(:/newPrefix/Side Bar.jpg);")
        self.Box4.setText("")
...
"}")
        ...
        self.UsernameLabel.setGeometry(QtCore.QRect(w-200, 35, 72, 14))
...
"}")
        ...
        self.MsgLabel.setGeometry(QtCore.QRect(w-250, 35, 16, 20))
        ...
        self.NotiLabel.setGeometry(QtCore.QRect(w-290, 35, 16, 20))
...
"}")
        ...
        self.DashboarLabel.setGeometry(QtCore.QRect((w/2)-450, (h/2)-300, 150, 27))
...
"}")
        ...
        self.NumSIgnLanLabel.setGeometry(QtCore.QRect((w/2)-430, (h/2)-220, 162, 27))
...
"}")
        ...
        self.NumAudLanLabel.setGeometry(QtCore.QRect((w/2)+70, (h/2)-220, 123, 28))
...
"}")
        ...
        self.AvgSignLanLabel.setGeometry(QtCore.QRect((w/2)+70, (h/2)+70, 154, 28))
...
"}")
        ...
        self.NumLabel.setGeometry(QtCore.QRect((w/2)-350, (h/2)-150, 181, 57))
...
"}")
        ...
        self.NumLabel_2.setGeometry(QtCore.QRect((w/2)+150, (h/2)-150, 181, 57))
...
"}")
        ...
        self.GraphLabel.setGeometry(QtCore.QRect((w/2)+70, (h/2)+100, 299, 130))
        ...
        self.ScrollBtn.setGeometry(QtCore.QRect((w/2)-100, (h/2)-230, 30, 30))
        # self.ScrollBtn.setPixmap(QPixmap("./Images/Icon awesome-greater-than.png"))
...
"}")
        ...
        self.ScrollBtn_2.setGeometry(QtCore.QRect((w/2)+400, (h/2)-230, 30, 30))
...
"}")
        ...
        self.DayLabel.setGeometry(QtCore.QRect((w/2)-150, (h/2)-220, 39, 14))
...
"}")
        ...
        self.DayLabel_2.setGeometry(QtCore.QRect((w/2)+350, (h/2)-220, 39, 14))
...
"}")
        ...
        self.ActiveUserCountlabel.setGeometry(QtCore.QRect((w/2)-200, (h/2)+120, 57, 73))
...
"}")
        ...
        self.ActiveUserlabel.setGeometry(QtCore.QRect((w/2)-200, (h/2)+200, 73, 13))
